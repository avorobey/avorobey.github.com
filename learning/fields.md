...
at the Galois group of some extension, $$Gal(N/K)$$, or even the absolute Galois group (to
be defined later) $$G(K)$$. What can be said about the connections between them?

A trivial example. $$Gal(K)==1$$ means there are no symmetries of roots of irreducible polynomials
